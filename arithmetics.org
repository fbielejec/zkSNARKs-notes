...
Choosing $n=6$ we have six remainder classes o fintegers that are congruent mod 6 (they have the same remainder when divided mod 6). Let's list them:
...
3) 13 is in the remiander class $r_1$, hence $2+5 \hspace{.5em} \text{mod 6} = 1$:
