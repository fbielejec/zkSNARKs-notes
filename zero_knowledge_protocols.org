...
For the first constraint we have (unofficial notation):
...
\end{bmatrix} \odot  \begin{bmatrix} 1 \\ I_{1} \\ I_{2} \\ I_{3} \\ I_{4} \\ W_{1} \\ W_{2} \\ W_{3} \\ W_{4} \\ W_{5} \\ W_{6} \\ W_{7} \end{bmatrix} = 1 \times W_{2}$

- Using maxima to simplify calculations:
