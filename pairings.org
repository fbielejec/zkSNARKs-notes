...
- [[#the-weil-pairing][The Weil Pairing]]
  - [[#function-f-multiplicity-at-a-point-pin-e][Function $f$ multiplicity at a point $P\in E$]]
  - [[#prerequisites-divisors-12][Prerequisites: Divisors [1/2]​]]
  - [[#example-501][Example 5.0.1]]
  - [[#the-weil-pairing][The Weil Pairing]]
  - [[#example-511-constructing-the-weil-pairing][Example 5.1.1: constructing the Weil pairing]]
- [[#additional-pairings-in-zk][Additional: pairings in ZK]]
  - [[#example-1][Example 1]]
  - [[#example-2][Example 2]]
:END:
...
* IN-PROGRESS Prerequisites: Meromorphic function
=Definition=
